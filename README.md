...
Sou **Desenvolvedora Full Stack** e graduanda em **Análise e Desenvolvimento de Sistemas**. Recentemente, concluí minha formação intensiva na **Generation Brasil**, onde consolidei habilidades técnicas em ecossistemas JavaScript e metodologias ágeis.

* 🎓 Atualmente cursando ensino superior em **Análise e Desenvolvimento de Sistemas**.
* 💻 Foco total em construir soluções escaláveis unindo **criatividade e lógica**.
* 🌍 Vivência internacional em **Portugal**, com experiência prévia em startup de criptomoedas.
